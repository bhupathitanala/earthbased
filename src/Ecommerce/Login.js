                            ...
                            <div>
                                ...
                                <form>
                                    <div>
                                        ...
                                        <br />
                                        <input type="email" style={{ borderColor: requiredFields['email'] }} onChange={(e) => setData({ ...data, email: e.target.value })} placeholder='Enter Your email' className='emailinputfield mb-3' />
                                    </div>
                                    <div>
                                        <label className='mb-2 mt-2  password'>Password</label>
                                        <br />
                                        <input type="password" onChange={(e) => setData({ ...data, password: e.target.value })} style={{ borderColor: requiredFields['password'] }} placeholder='Enter Your Password' className='emailinputfield mb-3' />
                                    </div>

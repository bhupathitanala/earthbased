...
function Mob_nav() {
    ...
    useEffect(() => {
        ...
        const initialActiveIndex = currentPath === '/' ? 0 : currentPath === '/usercart' ? 2 : currentPath === '/basic-vichaar' ? 3 : currentPath === '/blog' ? 4 : 5;
        ...
        <div className='d-block d-lg-none bottom-fixed'>
            <div className='navigation '>
                <ul>
                    ...
                    <li className={`list ${activeIndex === 2 ? 'active' : ''}`} onClick={() => activeLink(2)}><a href='/usercart'>
                        <span className='icon'>
                    ...
                    <li className={`list ${activeIndex === 3 ? 'active' : ''}`} onClick={() => activeLink(3)}><a href='/basic-vichaar'>
                        <span className='icon'><svg xmlns="http://www.w3.org/2000/svg" width="25" height="30" fill="current" class="bi bi-heart-fill" viewBox="0 0 16 10">
                    ...
                    <Navbar expand="lg" >
                        ...
                        <Navbar.Collapse id="basic-navbar-nav  " className='  nav_text' >
                            ...
                            <Nav className=" nav_con_main  d-flex   "  >
                                ...
                                <div className='mrkkm'>
                                    <Nav.Link href="#">   <div className="only_wish_sm     only_sm_cart" style={{ display: 'inline-block', borderRadius: '50%', height: '40px', width: '40px', }}>
                    ...
                    <div className='d-flex nav_third_card '>
                        {
                            categories.map((category) => {
                                return <div><p><a href={"/product/" + category.ID} style={{ textDecoration: 'none', color: 'black' }}>{category.categoryName}</a> </p> </div>
                            })
                        }

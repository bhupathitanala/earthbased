          ...
          <div className='row d-flex flex-row justify-content-evenly'>
            <div className='col-lg-6 col-xs-12 col-sm-12 col-md-6 '>
              <div className='flipbook_section'>
                <Flipbook width={300} height={500} ref={book} className='flip_book'>
                  ...
                  <div><img src={bv31} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv32} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv34} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv35} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv36} alt="BV-1" className='img-fluid' /></div>
                  <div></div>
                  <div></div>
                </Flipbook>
                <div className='text-center flip_buttons'>
                  <button onClick={() =>
              ...
              <div className='row justify-content-evenly mt-4'>
                ...
                <div className='col-lg-3 pt-1  download_button' >

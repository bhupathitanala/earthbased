        ...
        <div className='row'>
            <div className="col-lg-5 col-md-12 col-sm-12 d-none d-md-block">
              <div className="d-flex flex-row">
                <img src={contact} alt={contact} className="img-fluid contact_img ps-5 pt-5 pb-5"/>
              </div>
            </div>
              ...
              <div className='row'>
                ...
                <div className='col-lg-6 col-md-12 col-sm-12 form-secmob'>
                  <form className="form mobform">
                    ...
                    <input type="text" name="name" className=" feld_style" />
                    <p className="mt-2 contact_name">E-mail</p>
                    <input type="text"  name="email" className="field feld_style" />
                    <p className="mt-2 contact_name">Message</p>
                    <input type="text" name="message" className="field feld_style" />
                    <button className="button buttonmob">Contact Us</button>
                  </form>
                </div>
                ...
                <div className="col-lg-6 col-md-12 col-sm-12 d-none d-md-block d-lg-block">
                  <form className="form ">
                        ...
                        <p className='contact_pararaph'>+91 9646492525</p>
                        <h5 className="heading5">Contact</h5>
                        <p className='contact_pararaph'>hello@earthbased.store</p>
...
<div className='container-fluid' >
    <div className='row'>
        <div className='col-lg-12' style={{ width: '100%' , marginTop: '-50px'}}>
            <iframe
                title="Google Maps"
                width="100%"  
                height="350"

        ...
        <div className='container'>
          <div className='row '>
            <div className='col-lg-4 '  >
              ...
              <p className="our_mission_paragraph  sm_para">At EarthBased, our mission is to offer a compassionate and sustainable shopping experience for vegans, curating diverse, high-quality products that promote well-being, ethics, and environmental consciousness.  </p>
              <p className="our_mission_paragraph sm_para">We empower customers to align their values through conscious choices, supporting a healthier planet. Together, we build a thriving community dedicated to a compassionate and plant-based future.</p>
            </div>
            ...
            <div className='col-lg-4 d-none d-lg-block'   >
              ...
              <p className="our_mission_paragraph sm_para">Our Vision is to present a wide range of plant-based products that will make switching to a sustainable, cruelty free, vegan lifestyle easy and affordable. We want to show the world how a plant-based lifestyle can result in a healthy you and a healthy planet. We don’t intend on doing this all by ourselves. </p>
              <p className="our_mission_paragraph sm_para"> We are looking forward to building a strong community of plant-based lifestyle enthusiasts to have conversations with nutritionists, veteran vegans, sustainability experts, to understand what more can be done and what we can do to serve the community.</p>
            </div>
            ...
            <div className='    d-lg-none'   >
              ...
              <p className="our_mission_paragraph sm_para"> We are looking forward to building a strong community of plant-based lifestyle enthusiasts to have conversations with nutritionists, veteran vegans, sustainability experts, to understand what more can be done and what we can do to serve the community.</p>
                      ...
                      <a  className='read_more_drop_down_about' onClick={toggleSecondPara}>{showSecondPara ? 'Read Less' : 'Read More...'}</a>
          ...
          <div className='row'>
            <div className='col-lg-4 col-md-4 col-sm-12 order-2 order-sm-2 order-md-1'>
              <div className="d-flex flex-row justify-content-center img_mob">
                ...
                <img src={example_bloag_2} alt={example_bloag_2} className=' founder_img_radioud img-fluid  d-md-none' />
            ...
            <div className='col-lg-8 col-md-7 col-sm-12 order-1 order-sm-1 order-md-2 d-flex flex-column mt-5   d-lg-none'>
              <h1 className='about_heading1  text-center'>Our team</h1>
      ...
      <div className="about_section2 mt-5">
        <div className='container'>
          <div className='row'>
            ...
            <div className='col-lg-8 col-md-6 col-sm-12  d-lg-none'>

                ...
                <div className='container'>
                    <div className='row'>
                        ...
                        <div className='col-lg-5 col-md-12 col-sm-12'>
                            <h1 className='product_page_heading1'>5 in 1 Seed Mix 200G by Nourish You</h1>
                            <div className='d-flex flex-row'>
                                <p className='produt_page_starts'>⭐⭐⭐⭐⭐</p>
                                <p className='ms-2 produt_page_starts'>5/5</p>

                            </div>
                            <p className='product_page_price'>₹229.00</p>
                            <p className='product_page_text'>25 in stock</p>
                            <p className='category' style={{ margin: '0px' }}>Category : <span className='category_desc'>Health & Wellness, Healthy Diet foods</span> </p>
                            <div className='d-flex flex-row justify-content-between mt-3'>
                                {/* <p className='increment mt-3' style={{fontWeight:"600"}}>- 1 + </p> */}
                                <button className='add_to_card_button_produvt_page '  >Add To Cart</button>
                                <button className='buynow_button_product_page '  >Buy Now</button>
                            </div>
                            ...
                            <div className="mt-5 row">
                                <div className='col-3 justify_con'>
                                    ...
                                    <p className="mt-3">Natural & Organic</p>
                                </div>
                                <div className='col-3 justify_con'>
                                    <img src={icon2} alt={icon2} />
                                    <br />
                                    <p className="mt-3">NON  <br></br> GMO</p>
                                </div>
                                <div className='col-3  justify_con'>
                                    <img src={icon3} alt={icon3} />
                                    <p className="mt-3" >No Added   Preservatives</p>
                                </div>
                                <div className='col-3 justify_con'>
                                    <img src={icon4} alt={icon4} />
                                    <p className="mt-3">Gluten Free</p>
                                </div>
                            </div>
                        </div>
            ...
            <div className='Productpage_section2  mt-5'>
                <div className='container '>
                    <div className='row   product_page_options'>
                        <div className='col-3'>
                            <button className='share_button'>Share
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" className='ms-2 share_logo_product_page'>
                                    ...
                                    <path d="M15.41 6.51001L8.59 10.49" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </button>
                        </div>
                    <div className='col-3'>
                          <a href='#descriptionshash'>      <button className='des_button'>Description
                        ...
                        <a  href='#reviewssection'>       <button className='des_button add_info' > Reviews
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" className='ms-2 arrow_icon_product_page'>
                                    <path d="M7 7L17 17" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M17 7V17H7" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                        ...
                        <div className='col-3 d-none d-md-block'>
                            <button className='des_button  addtional_btn'>Additional information
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" className='ms-2 arrow_icon_product_page'>
                                    <path d="M7 7L17 17" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M17 7V17H7" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                        ...
                        <div className='col-3  d-none d-md-block'>
                        <a  href='#reviewssection'>  <button className='des_button reviws_btn'>Reviews
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" className='ms-2 arrow_icon_product_page'>
                                    <path d="M7 7L17 17" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M17 7V17H7" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
            ...
            <section>
                <div className='container mb-5 '  id='reviewssection'>
                    <div className='row'>
                        ...
                        {/* React slick slider */}
                        <Slider ref={sliderRef77} {...settings_2}>
                ...
                <div className='container mb-5'>
                    <div className='row'>
                        ...
                        <div className='col-4 arrow_div d-flex flex-row justify-content-end '>
                            <button className="p-2 mb-3 mr-1 second_carsoul_button_bg_product_page_left" type="button" onClick={goToPrev}>
                                <span className="carousel-control-prev-icon  product_icon_size_page_left" aria-hidden="true"></span>
                                <span className="visually-hidden">Previous</span>
                            </button>
                            <button className="ms-5 p-2 mb-3 second_carsoul_button_bg_product_page_right" type="button" onClick={goToNext}>
                                <span className="carousel-control-next-icon product_icon_size_page_right" aria-hidden="true"></span>
                                <span className="visually-hidden">Next</span>
                            </button>
                        </div>

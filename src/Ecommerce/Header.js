...
import trophy from '../assets/Gif-1-unscreen.gif';
import leafs from '../assets/leaf-gif-unscreen.gif';
...
function Header() {
  ...
  return (
    ...
    <>
      ...
      <div id="myCarousel" class="carousel slide container space_for_that" data-bs-ride="carousel"  >
      ...
      <div className='hello d-none d-lg-block'>
        ...
        <div className='container'    >
          ...
          <div className='hello'>
            <div className='row d-flex roling_marg flex-row justify-content-between'>
            ...
            {selectedCard && (
              <div className="maximized-card row roling_marg">
                ...
                <div className='col-md-5 col-xs-12' style={{ overflowY: 'auto', maxHeight: '400px' }}>
                  ...
                  <div className="mb-4 roling_marg row">
                    <div className='col-6'>
                  ...
                  <div class="shipping-icons1 mb-2">
                    <div class="shipping-icon-wrapper">
                      ...
                      <img src="https://earthbased.store/wp-content/uploads/2024/02/pan-india.webp"
                        alt="Pan India" class="shipping-icon" width={50} height={50} />
                    </div>
                    <div class="shipping-icon-wrapper">
                      <span className="icon-text">Above ₹1500</span>
                      <img src="https://earthbased.store/wp-content/uploads/2024/02/free_shipping.webp"
                        alt="Free Shipping" class="shipping-icon" width={50} height={50} />
                    </div>
                    <div class="shipping-icon-wrapper">
                      <span className="icon-text">Cash On Delivery</span>
                      <img src="https://earthbased.store/wp-content/uploads/2024/02/cod.webp" alt="COD"
              ...
              <div className='overflow-x-auto' >
                <div className='row roling_marg'>
                  <Carousel2 responsive={responsive}>
                    {topPicks.map((card) => (
                      <Col key={card.id} md={12} xs={12} className='mb-5'>
                        <div className='card card-body main_div_card_slick shadow' style={{ borderRadius: '20px', }}  >
        ...
        <div className='container'>
          ...
          <div className='row    roling_marg     mt-3'>
            ...
            <div className='col-md-4 col-5'>
              <img src={dealsoftheday} alt={dealsoftheday} className='img-fluid' />
        ...
        <div className='container'>
          <div className='row    roling_marg    '>
            ...
            <div className='col-4 arrow_div d-flex flex-row justify-content-end'>
              <button className="pt-1 pe-2  second_carsoul_button_bg_left" type="button" onClick={goToPrev99}>
                <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                <span className="visually-hidden">Previous</span>
              </button>
              <button className=" ms-5 pt-1 ps-2 second_carsoul_button_bg_right" type="button" onClick={goToNext99}>
...
<div className='container'>
  ...
  <div className='row     roling_marg    ' >
    <div className=' col-sm-12 col-md-6 col-lg-6 text-center '  style={ { marginTop:'-30px'}}>
    ...
    <div className=' col-sm-12 col-md-6 col-lg-6 text-center' style={ { marginTop:'-30px'}}>
      <img src={leafs} alt={trophy} className=' img-fluid' />
    ...
    <button class="carsoul_button_bg_right_5 mx-2" type="button" onClick={goToNext5}>
      ...
      <section>
        <div className='maaq_con_three2 py-5'>
          <h2 className='text-center mb-5'><b>Featured in</b></h2>

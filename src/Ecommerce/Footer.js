                        ...
                        <div className='row'>
                            < div className='col-12 col-md-3'   >
                                ...
                                <div className='d-flex footer_social my-4'>
                                    ...
                                    <p><a href="#" className='insta_app' >   <i class="bi bi-instagram"></i></a>
                                    </p>


                                    <p><a href="#" className='twitter_app'>    <i class="bi bi-twitter-x"></i></a>
                                    </p>

                                    <p><a href="#" className='linked_app'   >    <i class="bi bi-linkedin"></i></a>
                                    </p>
                            ...
                            < div className='col-12 col-md-3 d-none d-md-block'>
                                ...
                                <p className='footer_p_tag'><a href="#">Become a Vendor</a></p>

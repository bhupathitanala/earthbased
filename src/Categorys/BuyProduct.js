                    ...
                    <div className="steps">
                        <div className="steps-header">
                            <div className="progress">
                                <div className="progress-bar" role="progressbar" style={{ width: currentStepIndex * 25 + '%' }} aria-valuenow={(currentStepIndex + 1) * 25} aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                        <div className="steps-body">
                            {stepData.map((item, index) => (
                                <div className={"step " + item.stepClassName} style={{ height: '100px' }} key={index}>

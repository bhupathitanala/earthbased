...
function Products() {
    ...
    console.log(filteredProducts, subCategories)
                            ...
                            <div className="col-12">
                                <div>
                                    ...
                                    <ul className="list-unstyled">
                                        <li>
                                            <a href="#" className={`btn ${selectedCategory === "All" ? "btn-secondary" : ""} ${selectedCategory === "All" ? "selected" : ""}`} onClick={() => setSelectedSubCategory("All")}>All Categorys</a>
                                        </li>
                                        {
                                            subCategories.map(subCategory => {
                                                return <li>
                                                    <a href="#" className={`btn ${selectedCategory === "Beauty_bath" ? "btn-secondary" : ""} ${selectedCategory === "Beauty_bath" ? "selected" : ""}`} onClick={() => setSelectedSubCategory(subCategory.ID)}>{subCategory.subCategoryName}</a>
                                                </li>
                                            })
                                        }
                                        {/* <li>
                                    ...
                                    <div className="col-lg-3 col-md-3 col-sm-12 mb-5 " key={product.name}>
                                        <div className="card" style={{ borderRadius: '20px' }}>
                                            ...
                                            <div className="image_border  hover_img">
                                                <img src={'http://localhost:3009/' + JSON.parse(product.productImages)[0]} alt={product.name} className='img-fluid shopimg p-3' />
                            ...
                            {selectedCard && (
                                <div className="maximized-card row">
                                    <div className='col-md-5 col-xs-12'>
                                        ...
                                        <img src={'http://localhost:3009/' + JSON.parse(selectedCard.productImages)[0]} alt={selectedCard.title} className='img-fluid' id="mainImage" />
                                    ...
                                    <div className='col-md-2'>
                                        {
                                            JSON.parse(selectedCard.productImages).map((item, index) => {
                                                if (index !== 0) {
                                                    return <img src={'http://localhost:3009/' + JSON.parse(selectedCard.productImages)[index]} alt={selectedCard.title} className='img-fluid' onClick={() => handleImageClick(index)} />
                                                }
                                            })
                                        }
                                        {/* <img src={'http://localhost:3009/' + JSON.parse(selectedCard.productImages)[1]} alt={selectedCard.title} className='img-fluid' onClick={() => handleMiniImageClick1(selectedCard.image_mini1)} />
                                    <img src={'http://localhost:3009/' + JSON.parse(selectedCard.productImages)[2]} alt={selectedCard.title} className='img-fluid' onClick={() => handleMiniImageClick2(selectedCard.image_mini2)} />
                                    <img src={'http://localhost:3009/' + JSON.parse(selectedCard.productImages)[3]} alt={selectedCard.title} className='img-fluid' onClick={() => handleMiniImageClick3(selectedCard.image_mini3)} />
                                    <img src={'http://localhost:3009/' + JSON.parse(selectedCard.productImages)[4]} alt={selectedCard.title} className='img-fluid' onClick={() => handleMiniImageClick4(selectedCard.image_mini4)} /> */}
                                    </div>
